...
// GEMCode
#include "L1Trigger/GEMCSCNtuplizer/interface/MatcherManager.h"

// NtupleMaker tools
#include "L1Trigger/GEMCSCNtuplizer/test/TreeDigi.cc"
#include "L1Trigger/GEMCSCNtuplizer/test/GEMTool.cc"
